#!/usr/bin/env bash
echo Hello Lets start Variables
...
echo -e "Good Morning, Today date is 2020-02-12:" `date`
...
# Ex: export B_E=DevOps and run sh 04.variables.sh
